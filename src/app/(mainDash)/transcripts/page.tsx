...
export default function Home() {
  ...
  const fetchTranscripts = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get('https://pde9nag7w2.execute-api.us-east-2.amazonaws.com/Dev1/upload-transcript');
          ...
          {transcripts.map((transcript, index) => {
            ...
            return (
              ...
              >
                ...
                <p>Transcript ID: {transcript.transcript_id || 'Not available'}</p>
                <div className="text-[#9ea5ad] mb-4">
                  <p><span className="font-bold text-[#ced2d6]">Created:</span> {transcript.created_date}</p>
                  <p><span className="font-bold text-[#ced2d6]">Uploaded:</span> {transcript.upload_date}</p>
